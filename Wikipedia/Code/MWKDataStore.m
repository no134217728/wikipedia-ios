...
@property (nonatomic, strong) WikidataFetcher *wikidataDescriptionEditingController;
...
- (instancetype)initWithContainerURL:(NSURL *)containerURL {
    ...
    if (self) {
        ...
        self.wikidataDescriptionEditingController = [[WikidataFetcher alloc] initWithSession:session configuration:configuration];
